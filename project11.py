...
def create_app_ui():
    dropdown_style={'width':'99%','margin':'auto',"padding-top": "4px","padding-bottom":"2px","border-radius":"25px",}
    main_layout = html.Div(
      style={"background-color": "#98FB98"},
      className="Test",
      children=[
       html.Hr(className='line'),
      html.H1(id='Main_title',children ='Terrorism Analysis with Insights',style = {'textAlign':'center', 'background-color': 'rgba(0, 128, 0, 0.3)','font-size': '2.90em','color' : 'Black'}),
     html.Hr(className='line'),
  ...
  html.Div(id = "graph-object", children ="Map loading!!!!!!!!!!!!!")
  ])
    return main_layout
